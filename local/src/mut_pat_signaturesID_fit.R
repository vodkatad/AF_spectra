...
indel_grl <- get_indel_context(vcfs, ref_genome)
mut_mat <- count_indel_contexts(indel_grl)

save.image('indels_sign.Rdata')
### cosmic ID
ref_signatures = get_known_signatures(muttype = "indel", source='COSMIC_v3.2') # genome='GRCh38') not available
##

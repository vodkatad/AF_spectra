...
dndsall <- read.table('/scratch/trcanmed/AF_spectra/datasetV2/dndsfixed_subclonal.tsv', sep="\t", header=FALSE)
colnames(dndsall) <- c('model','estimate', 'lower', 'upper')

dndspooled <- read.table('/scratch/trcanmed/AF_spectra/datasetV2/dnds_subclonal_poolMSS_t0.tsv', sep="\t", header=TRUE)
...
ggsave('~/test_poolMSS.svg', plot=p, width=89, height=89, units="mm")
################ 1c not subclonal
...
dndsall <- read.table('/scratch/trcanmed/AF_spectra/datasetV2/dnds1vitro_overall.tsv', sep="\t", header=FALSE)
colnames(dndsall) <- c('model','estimate', 'lower', 'upper')

dndspooled <- read.table('/scratch/trcanmed/AF_spectra/datasetV2/dnds_vitroMSS_t1.tsv', sep="\t", header=TRUE)
colnames(dndspooled) <- c('model','estimate', 'lower', 'upper')
...
ggsave('~/test_poolMSS_1c.svg', plot=p, width=89, height=89, units="mm")

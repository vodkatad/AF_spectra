...
### dati lisci non differenziali
files <- c("CRC0282/re_platypus_filtered.vcf.gz","CRC0327/re_platypus_filtered.vcf.gz", "CRC1078/re_platypus_filtered.vcf.gz", "CRC1307_clones_mutect/re_platypus_filtered.vcf.gz",  "CRC1502/re_platypus_filtered.vcf.gz")
files <- paste0('/scratch/trcanmed/AF_spectra/local/share/data/', files)
sample_names <- c('CRC0282','CRC0327','CRC1078','CRC1307','CRC1502') 
